...
function(){
    if(document.visibilityState === "visible"){
        document.title = "Portfolio | Satish Chaurasia";
        $("#favicon").attr("href","assests/images/My_Photo_2-removebg.png");
    }
    else {
...
// <!-- typed js effect starts -->
    var typed = new Typed(".typing-text", {
        strings: ["MERN Stack Developer", "Competitive Programmer","Active Member in Tech Communities",  "CSE Student", ],
        loop: true,
        typeSpeed: 50,
		backSpeed: 25,
		backDelay: 500,
